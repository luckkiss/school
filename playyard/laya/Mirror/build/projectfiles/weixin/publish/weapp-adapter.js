	...
	var XMLHttpRequest = function () {
	  ...
	  _createClass(XMLHttpRequest, [{
	    ...
	    value: function send() {
          ...
          var thisurl = _url.get(this);
          var rp = this.responseType;
          var dt=null;
          if (thisurl.indexOf(".json") != -1 || thisurl.indexOf(".atlas") != -1 || thisurl.indexOf(".lh") != -1 
            || thisurl.indexOf(".lmat") != -1 || thisurl.indexOf(".ls") != -1 || thisurl.indexOf(".php") != -1
            || thisurl.indexOf(".lav") != -1) {
            dt = "string"
          }
	        wx.request({
	          data: data,
            ...
            dataType: dt,
	          success: function success(_ref) {
	            ...
	            if (typeof data !== 'string' && !(data instanceof ArrayBuffer)) {
                  ...
                  console.warn('[微信JSON.stringify]:' + thisurl)
	              } catch (e) {
	                data = data;
	              }
	            }
	            ...
	            if (data instanceof ArrayBuffer) {
	              ...
	              // }
                // console.log("==ArrayBuffer==:" + thisurl)
	            } else {
